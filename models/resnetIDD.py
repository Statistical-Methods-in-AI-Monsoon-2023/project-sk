...
class ResNet56IDD(nn.Module):
    def __init__(self, margs="noshort", num_blocks=[9,9,9], num_classes=10):
        super(ResNet56IDD, self).__init__()
        # Img of shape (B, 3, H, W) becomes (B, 64, H/32, W/32)
        ...
        # Heatmap and Confidence scores
        self.projConv = nn.Conv2d(64, 2, kernel_size=1, stride=1, padding=1, bias=False)
