      ...
      (function() {
          ...
          if (b.instantiateWasm)
              try {
                  ...
                  return qa("Module.instantiateWasm callback failed with error: " + g),
                  !1
              }
          (function() {
          ...
          if (!(0 < Ma)) {
              if (b.preRun)
                  for ("function" == typeof b.preRun && (b.preRun = [b.preRun]); b.preRun.length; )
                      La();
              Fa(Ga);
              0 < Ma || (b.setStatus ? (b.setStatus("Running..."),
              setTimeout(function() {
                  setTimeout(function() {
                      b.setStatus("")
                  }, 1);
