...
parser.add_argument('--dataset', type=str, default="cifar10", help='Dataset the model was trained on')
...
def get_eigvecs(args):
    models = []
    sorted = sorted(os.listdir(args.weight_path), key=lambda x: int(os.path.splitext(x)[0]))
